...
app_publisher = "AUIM System "
app_description = "Frappe HRMS payroll customizations that allow employee besed specific earings and deductions to be added under employee salary tab. "
app_email = "auim@auim"
app_license = "mit"
# required_apps = []
